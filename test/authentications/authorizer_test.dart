  ...
  group('Authorizer', () {
    group('validatePrivateChannelName', () {
      test('should accept valid private channel names', () {
        ...
        expect(
          () => validatePrivateChannelName('private-user-123'),
          returnsNormally,
        );
        expect(
          () => validatePrivateChannelName('private-room-abc'),
          returnsNormally,
        );
        expect(
          () => validatePrivateChannelName('private-test_channel'),
          returnsNormally,
        );
        expect(
          () => validatePrivateChannelName('private-channel-with-hyphens'),
          returnsNormally,
        );
      });
      ...
      test('should reject empty channel names', () {
        expect(
          ...
          throwsA(
            isA<InvalidChannelNameException>().having(
              (e) => e.message,
              'message',
        ...
        expect(
          ...
          throwsA(
            isA<InvalidChannelNameException>().having(
              (e) => e.message,
              'message',
              contains('Channel name contains invalid characters'),
            ),
          ),
        );
    ...
    group('AuthenticationException', () {
      ...
      test('should format toString correctly without status code', () {
        ...
        expect(
          exception.toString(),
          'AuthenticationException: Test error for channel "private-test"',
        );
      });
      ...
      test('should format toString correctly with status code', () {
        ...
        expect(
          exception.toString(),
          'AuthenticationException: Forbidden (HTTP 403) for channel "private-test"',
        );
      });
    });
  });
